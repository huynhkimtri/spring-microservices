...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.fullstackjhipster.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.fullstackjhipster.security.DomainUserDetailsService", "createSpringSecurityUser");
